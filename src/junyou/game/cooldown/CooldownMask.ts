        ...
        */
        ...
        public doRender(delta: number): void {
            if (this._mask.stage) {
                ...
                var radus = this._deltaRadus * this._duration;
                ...
                if (radus < CooldownMask._45) {
                    y = oy;
                    x = hl + Math.tan(radus) * hl;
                    g.moveTo(hl, oy);
                    g.lineTo(hl, hl);
                    g.lineTo(x, y);
                    g.lineTo(sl, oy);
                ...
                else if (radus >= CooldownMask._45 && radus < CooldownMask._135) {
                    x = sl;
                    y = hl - hl / Math.tan(radus);
                    g.moveTo(hl, oy);
                    g.lineTo(hl, hl);
                    g.lineTo(x, y);
                    g.lineTo(sl, sl);
                ...
                else if (radus >= CooldownMask._135 && radus < CooldownMask._225) {
                    y = sl;
                    x = radus > CooldownMask._lt180 && radus < CooldownMask._gt180 ? hl : hl - hl * Math.tan(radus);
                    g.moveTo(hl, oy);
                    g.lineTo(hl, hl);
                    g.lineTo(x, y);
                    g.lineTo(ox, sl);
                ...
                else if (radus >= CooldownMask._225 && radus < CooldownMask._315) {
                    x = ox;
                    y = hl + hl / Math.tan(radus);
                    g.moveTo(hl, oy);
                    g.lineTo(hl, hl);
                ...
                else if (radus >= CooldownMask._315) {
                    y = oy;
                    x = hl + Math.tan(radus) * hl;
                    g.moveTo(hl, oy);
                    g.lineTo(hl, hl);
        ...
        public add(cdTotalTime: number): void {
            if (cdTotalTime)
                this._deltaRadus = Math.PI * 2 / cdTotalTime;
            this._duration = 0;
            let g = this._g;
            g.clear();
            g.beginFill(CooldownMask.COLOR, CooldownMask.ALPHA);
