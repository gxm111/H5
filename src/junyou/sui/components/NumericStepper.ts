module junyou.sui {
    export class NumericStepper extends Component {
        ...
        public static VALUE_CHANGE: string = "NumericStepper_valueChange";
        ...
        public addSubComponents() {
            ...
            this.subBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.subValue, this);
            this.addBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.addValue, this);
            ...
            if (this.minBtn) {
                ...
                this.minBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.setMinValue, this);
            }

            if (this.maxBtn) {
                this.addChild(this.maxBtn);
                this.maxBtn.enabled = true;
                this.maxBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.setMaxValue, this);
        ...
        public set value(val: number) {
            if (this._value != val) {
                ...
                this.dispatchEventWith(NumericStepper.VALUE_CHANGE);
            }
        }
