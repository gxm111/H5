module junyou.sui {
    export class Slider extends Component {
        ...
        public static VALUE_CHANGE: string = "SLIDER_VALUE_CHANGE";
        ...
        private onAddToStage(e: egret.Event) {
            if (this._barEnabled) {
                this.stage.addEventListener(egret.TouchEvent.TOUCH_END, this.bgOut, this);
            }
        }
        /*使不使用底条点击直接设值 */
        public set barEnabled(value: boolean) {
            ...
            if (value) {
                this.bgline.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.bgClick, this);
                if (this.stage) {
                    this.stage.addEventListener(egret.TouchEvent.TOUCH_END, this.bgOut, this);
                }
                ...
                this.bgline.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.bgClick, this);
                if (this.stage) {
                    this.bgline.removeEventListener(egret.TouchEvent.TOUCH_END, this.bgOut, this);
                }
        ...
        private onThumbEnd(e: egret.TouchEvent) {
            ...
            this.thumb.removeEventListener(egret.TouchEvent.TOUCH_END, this.onThumbEnd, this);
            this.thumb.removeEventListener(egret.TouchEvent.TOUCH_RELEASE_OUTSIDE, this.onThumbEnd, this);
        }
        ...
        public set value(val: number) {
            ...
            this._value = val;
            this.dispatchEvent(new egret.Event(Slider.VALUE_CHANGE));
