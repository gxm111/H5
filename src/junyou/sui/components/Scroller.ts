module junyou.sui {
    export class Scroller extends egret.EventDispatcher {
        ...
        public static SCROLL_POSITION_CHANGE = "SCROLL_POSITION_CHANGE";
        ...
        public bindObj(content: egret.DisplayObject, scrollRect: egret.Rectangle, scrollbar?: ScrollBar) {
            ...
            content.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTargetTouchBegin, this);
            if (scrollbar) {
                ...
                if (scrollbar.stage) {
                    ...
                    scrollbar.addEventListener(egret.Event.ADDED_TO_STAGE, this.onScrollBarAdded, this);
                }
        ...
        protected onTargetTouchBegin(e: egret.TouchEvent) {
            ...
            this._content.stage.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.moveOnContent, this);
            this._content.addEventListener(egret.TouchEvent.TOUCH_END, this.endTouchContent, this);
            this._content.addEventListener(egret.TouchEvent.TOUCH_RELEASE_OUTSIDE, this.endTouchContent, this);
            if (this._useScrollBar) {
                if (!this.alwaysShowBar) {
        ...
        protected onEnterFrame(e: egret.Event) {
            if (this._moveSpeed == 0) {
                this._content.removeEventListener(egret.Event.ENTER_FRAME, this.onEnterFrame, this);
                if (this._useScrollBar) {
                    if (!this.alwaysShowBar) {
                        let tween: junyou.Tween = Global.getTween(this._scrollbar, undefined, undefined, true);
        ...
        protected endTouchContent(e: egret.TouchEvent) {
            this._content.stage.removeEventListener(egret.TouchEvent.TOUCH_MOVE, this.moveOnContent, this);
            this._content.removeEventListener(egret.TouchEvent.TOUCH_END, this.endTouchContent, this);
            this._content.removeEventListener(egret.TouchEvent.TOUCH_RELEASE_OUTSIDE, this.endTouchContent, this);
            let now: number = Global.now;
            if (now - this._lastMoveTime < 150) {
                this._content.addEventListener(egret.Event.ENTER_FRAME, this.onEnterFrame, this);
        ...
        public doScrollContent(sub: number) {
            ...
            if (oldx != rect.x || oldy != rect.y) {
                this._content.dispatchEvent(new egret.Event(Scroller.SCROLL_POSITION_CHANGE));
            }
        ...
        protected checkScrollEnd() {
            ...
            this._scrollEnd = contentSize - scrollSize;
        }
