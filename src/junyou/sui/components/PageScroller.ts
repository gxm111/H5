module junyou.sui{
    ...
    export class PageScroller extends Scroller{
        ...
        public static PAGE_CHANGE:string = "PAGE_CHANGE";
        /**
         * 当前在第几页
         * 
         * @type {number}
        ...
        protected endTouchContent(e:egret.TouchEvent){
            ...
            if(now - this._lastMoveTime < 150){
             ...
             this._content.stage.addEventListener(egret.Event.ENTER_FRAME,this.autoScrollToNextPage,this);
        }
        ...
        private autoScrollToNextPage(e:egret.Event){
            ...
            if(Math.abs(subdis) < sub||Math.abs(subdis)<2){
                this._content.stage.removeEventListener(egret.Event.ENTER_FRAME,this.autoScrollToNextPage,this);
