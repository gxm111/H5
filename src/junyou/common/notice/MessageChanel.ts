module junyou {
    ...
    export class MessageChanel {
        ...
        public addMessage(msgs: any[]) {
            ...
            this._waitList = this._waitList.concat(msgs);
            this.checkNext();
            if (this.isruning == false) {
                this.isruning = true;
                this._con.addEventListener(egret.Event.ENTER_FRAME, this.tick, this);
            }
        }
        ...
        private getMessageRender(index: number) {
            ...
            if (!render) {
                ...
                render.addEventListener(MessageRender.CHECK_END, this.checkEnd, this);
                render.addEventListener(MessageRender.CHECK_NEXT, this.checkNext, this);
            }
            return render;
        }
        ...
        private checkEnd(e: egret.Event) {
            ...
            if (isruning == false) {
                this._con.removeEventListener(egret.Event.ENTER_FRAME, this.tick, this);
                this.isruning = false;
            }
        }
